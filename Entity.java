...
class Entity{
  ...
  private static String[] enemystats = {
    ...
    "Lichen                 l  1 300  4  1  0 Health  10", 
    "\"Grid Bug\"           g  1 400  5  1  0 Health  5", 
    "Rat                    r  1 300  6  2  0 Bronze  10", 
    "Dog                    d  3 250 10  4  1 Bronze  12", 
    "Wildcat                W  4 200  8  6  2 Steel    5 Iron    10 Bronze 15", 
    "\"Fedora Man\"         f  5 500 15  5  5 Black   15 Steel   10 Health 15", 
    "Owl                    o  3 250 10  4  2 Steel    5 Iron     5 Bronze 20", 
    "Ogre                   O  7 350 25 10 10 Mithril  5 Black   20 Steel  10 Iron   10 Health 10", 
    "\"Steve Bushcemi\"     e 10 225 30 13 20 Mithril 10 Black   20 Steel  20 Health 50",
    "Dragon                 D 15 275 40 15 22 Mithril 30 Black   30",
    "\"Spooky Ghost\"       G 18 300 30 30 10 Adamant  5 Mithril 10",
    "Rouge                  R 18 150 20 30 50 Adamant  5 Mithril 15 Health 20",
    "\"Mr. Mister Donald\"  T 20 175 30 40 10 Adamant 15 Mithril 15 Health 35",
    "Fiend                  F 22 225 40 40 15 Adamant 20 Black   30",
    "Imp                    I 25 275 45 45 25 Adamant 15 Mithril 20 Health 30",
  ...
  public static int pickEnemy(int level){
    int spread = RandomNumber.getNormalRand(0,4, 2, 1);
    int itr = 0;
    int tries = 0;
    do{
      itr = RandomNumber.getRand(1, enemys.size());
      tries++;
